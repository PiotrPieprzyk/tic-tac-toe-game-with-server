...
export function RoomList(): ReactElement {
    ...
    return (
        <div data-testid="roomList">
            ...
            {ownRoomId ? (
                <Button data-testid="returnToRoom" onClick={() => router.push(`#/rooms/${ownRoomId}`)}>
                    RETURN_TO_ROOM
                </Button>
            ) : (
                <Button data-testid="createRoom" onClick={() => router.push('#/rooms/create')}>
                    CREATE_ROOM
                </Button>
            )}
            ...
            {loading ? (
                ...
                <EmptyState data-testid="noActiveRoomsFound">NO_ACTIVE_ROOMS_FOUND</EmptyState>
            ) : (
